class item{
    constructor(price = 0, xion_amount = 0, price_coeff = 1.12, frequency = 1000.0, multiplier = 1, player_owned = 0){
        this.name = "";
        this.price = price;
...
class xion extends item{
    constructor(initial_price = 0, xion_amount = 1, price_coeff = 0, frequency = 0, multiplier = 1, player_owned = 1){
        super(initial_price, xion_amount, price_coeff, frequency, multiplier, player_owned);
        this.name = "xion";
    }
}

class autoclicker extends item{
    constructor(initial_price = 10, xion_amount = 1, price_coeff = 1.08, frequency = 5000.0, multiplier = 1, player_owned = 0){
        super(initial_price, xion_amount, price_coeff, frequency, multiplier, player_owned);
...
class xiongenerator extends item{
    constructor(initial_price = 1000, xion_amount = 10, price_coeff = 1.12, frequency = 4000.0, multiplier = 1, player_owned = 0){
        super(initial_price, xion_amount, price_coeff, frequency, multiplier, player_owned);
